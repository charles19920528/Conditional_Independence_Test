...
# 1 layer
number_forward_layers_vet = [8, 12, 16]
hidden_dim_mixture_vet = [80, 120, 160, 190]
...
##################################
number_forward_layers_vet = [8, 12, 16, 24, 32]
hidden_dim_mixture_vet = [80, 120, 160, 190, 300]
learning_rate_mixture = hp.learning_rate_mixture
