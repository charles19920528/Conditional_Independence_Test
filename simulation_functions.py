...
def simulation_loop(simulation_wrapper, scenario, result_dict_name, sample_size_vet = hp.sample_size_vet,
    ...
    for sample_size in hp.sample_size_vet:
        ...
        pool_result_vet = pool.map(partial(simulation_wrapper, sample_size=sample_size, scenario=scenario, **kwargs),
...
def ising_simulation_wrapper(simulation_index, scenario, sample_size):
    ...
    ising_training_pool_instance = gt.IsingTrainingPool(z_mat=z_mat)
