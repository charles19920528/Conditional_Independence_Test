...
sf.ising_bootstrap_loop(pool=pool, data_directory_name="mixture_data", scenario="null",
                        ...
                        result_dict_name="bootstrap_mixture_50_100",
                        trial_index_vet=hp.trial_index_vet, network_model_class=gt.FullyConnectedNetwork,
                        network_model_class_kwargs_vet=mixture_network_model_class_kwargs_vet,
                        number_of_bootstrap_samples=2, max_epoch_vet=max_epoch_vet,
