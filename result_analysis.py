...
ising_fpr_tpr_dict = ra.fpr_tpr(null_result_dict = ising_result_null_dict, alt_result_dict = ising_result_alt_dict,
                             test_statistic_one_sample = ra.ising_test_statistic_one_trial)

ra.plot_roc(ising_fpr_tpr_dict, "Ising_Model")
...
naive_chisq_fpr_tpr_dict = ra.fpr_tpr(null_result_dict = naive_chisq_result_null_dict,
                             ...
                             test_statistic_one_sample = ra.naive_sq_statistic_one_trail, isPvalue = False)

ra.plot_roc(naive_chisq_fpr_tpr_dict, "Naive_Chisq")
...
stratified_chisq_fpr_tpr_dict = ra.fpr_tpr(null_result_dict = stratified_chisq_result_null_dict,
                                        ...
                                        test_statistic_one_sample = ra.stratified_sq_statistic_one_trail)

ra.plot_roc(stratified_chisq_fpr_tpr_dict, "Stratified_Chisq")
